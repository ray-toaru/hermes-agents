...
| --- | --- | --- | --- |
| Authenticated approval verification | ADR 0008 | Approval YAML and identity evidence exist, but no live or signed verification exists. | Implement fail-closed live GitHub or signed-attestation approval verification bound to repository, change ID, diff hash, approver, decision, time, and threshold. |
